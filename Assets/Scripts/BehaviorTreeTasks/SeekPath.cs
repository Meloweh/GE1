...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D
{
    ...
    public class SeekPath : Action
    {
        ...
        public override void OnStart()
        {
            ...
            var targets_ = Physics2D.OverlapCircleAll(transform.position, outerRadius, mask);
            var targets = targets_.ToList().Where(t => t.gameObject.GetComponent<GameObjectDistance>().State == PathStates.NEXT).ToList();
